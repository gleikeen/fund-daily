...
<div class="snap">
  <b>⚠️ 估值口径与快照时点说明：</b>本次为 <b>{RUN_TS} 盘中自动化执行</b>。① <b>基金估值分位沿用平安证券指数信号灯最新口径（基准日 7/15 收盘，近十年分位）</b>，日内稳定、与 7/14、7/15、7/16-08 版一致。② <b>7/16 盘中行情（截至 13:45 核验）：</b>A 股午盘震荡走弱——沪指 <b>-0.82%</b>、深成指 -0.83%、创业板 <b>-1.73%</b>、科创综指 -0.76%，半日成交 1.48 万亿（缩量 2351 亿）、<b>超 3200 只个股上涨</b>；盘面呈"低位医药/消费/防御强、高位科技弱"——<b>影视院线/医疗服务/文化传媒/消费电子/猪肉涨幅居前，存储芯片/半导体/煤炭/油气跌幅靠前</b>，医药板块反复活跃（哈药 5 连板）、影视院线强势（儒意 2 连板）。港股逆势走强——恒指 +1.93%、<b>恒科 +3.08%（盘中最高 +3.37%、冲击三连阳）</b>，科网股集体上涨（美团/B站 +5%、阿里 +4~5%、百度 +3%）；<b>韩国央行意外加息 25bp（2.50%→2.75%）致 KOSPI -7%、日经 -3%，资金回流港股</b>；南向连续 2 日爆买超百亿（7/14 约 110 亿、7/15 超 130 亿）。③ <b>宏观/地缘：</b>美军 7/15 对伊朗发动<b>第二波打击</b>、伊朗强硬回击，油价三连涨（WTI 79.60/布伦特 84.95）；美联储褐皮书温和、库克称通胀降温、特朗普希望降息（7 月加息概率降至约 10%）；网信办发布 7 款手机端侧 AI 备案（Apple 智能等）；昭衍新药确认实验猴涨价（食蟹猴 15-20 万、订单排期 4-5 个月）印证 CRO 景气。
</div>

<div class="lead">
  <strong>综合视角（7/16 盘中 · 午盘+午后）：</strong>今日 A 股早盘低开，沪指 <b>-0.82%</b>、创业板 <b>-1.73%</b>，但<b>超 3200 只个股上涨</b>、半日成交 1.48 万亿，呈"指数弱、个股分化"格局——<b>医药/影视/消费电子/猪肉逆势领涨，半导体/存储/煤炭/油气延续调整</b>（德明利连续 2 日跌停）。与之相对，<b>港股强势三连阳</b>：恒指 +1.93%、恒科 +3.08%（阿里 +4~5%、美团/B站 +5%），受<b>韩国加息引发资金回流 + 南向连续 2 日爆买超百亿 + 美股中概隔夜大涨</b>三重驱动。结构性低估格局未变：<strong>医疗(512170) 维持"强烈偏多·领涨"；中概互联(513050)/恒科(513180) 受中概+港股共振强化、偏多；白酒(161725)/消费红利(008928) 偏多·较强（服务消费占优）；银行(512800) 防御占优；券商(512880) 今日板块走弱（证券午盘跌幅靠前），短线承压、但中金三合一+中报预增中期逻辑未变。</strong>
</div>

<div class="flash">
  <b>✅ 7/16 盘中关键变化（自动化执行 · 公开资讯核验）：</b>① <b>港股三连阳 + 资金回流：</b>恒指 +1.93%、<b>恒科 +3.08%（盘中 +3.37%、冲击三连阳）</b>，美团/B站 +5%、阿里 +4~5%、百度 +3%；<b>韩国央行意外加息 25bp（2.50%→2.75%）致 KOSPI -7%、日经 -3%，资金回流港股</b>；南向连续 2 日爆买超百亿（7/14 约 110 亿、7/15 超 130 亿），7 月累计净流入显著。② <b>🔥 A 股结构分化延续：</b>沪指午盘 -0.82%、创业板 -1.73%，但超 3200 只上涨；<b>影视院线/医疗服务/文化传媒/消费电子/猪肉涨幅居前</b>，哈药 5 连板、儒意 2 连板；<b>存储芯片/半导体/煤炭/油气跌幅靠前</b>（德明利连续 2 日跌停），科创回调延续。③ <b>🔥 医药景气强化：</b>昭衍新药确认实验猴涨价（食蟹猴 15-20 万/只、订单排期 4-5 个月）印证 CRO 景气回升；中信证券指医药创新企业未来 3-5 年持续稳健增长、重点关注医疗健康产业；医保目录形式审查进专家评审。④ <b>🔥 消费结构向服务倾斜：</b>国泰海通指 2026H1 服务零售 +5.3%、商品零售 +1.1%，服务消费抗周期属性凸显。⑤ <b>美伊冲突升级确认：</b>美军 7/15 对伊朗发动第二波打击、伊朗强硬回击，油价三连涨（WTI 79.60/布伦特 84.95）；美联储褐皮书温和、特朗普希望降息、7 月加息概率降至约 10%。⑥ <b>AI 事件：</b>网信办发布 7 款手机端侧 AI 备案（Apple 智能、华为小艺、vivo 蓝心、小米澎湃、努比亚豆包等）；WAIC2026（7/17-20 上海）临近。
</div>

<div class="grid">
  <div class="kpi"><div class="n">{len(FUNDS)}</div><div class="l">入选低估基金（通过筛选 7 只）</div></div>
  <div class="kpi"><div class="n">+3.08%</div><div class="l">恒科午盘（三连阳·港股强）</div></div>
  <div class="kpi"><div class="n">连续2日</div><div class="l">南向爆买超百亿港元</div></div>
  <div class="kpi"><div class="n">超3200只</div><div class="l">A股午盘上涨（指数弱·个股分化）</div></div>
  <div class="kpi"><div class="n">+3.37%</div><div class="l">恒科 13:45 盘中（阿里+4~5%）</div></div>
</div>

<h2>零、7/16 市场快照（7/16 盘中 · 午盘+午后行情）</h2>
<p>2026-07-16 A 股早盘低开、午盘走弱：沪指 <b>-0.82%</b>、深成指 -0.83%、创业板 <b>-1.73%</b>、科创综指 -0.76%，半日成交 1.48 万亿（缩量 2351 亿），但<b>全市场超 3200 只个股上涨</b>，呈"指数弱、个股分化"格局；盘面呈"低位医药/消费/防御强、高位科技弱"——<b>影视院线/医疗服务/文化传媒/消费电子/猪肉涨幅居前，存储芯片/半导体/煤炭/油气跌幅靠前</b>，医药板块反复活跃（哈药 5 连板）、影视院线强势（儒意 2 连板）。与之相对，<b>港股逆势三连阳</b>：恒指 +1.93%、恒科 +3.08%（盘中最高 +3.37%），科网股集体上涨（阿里 +4~5%、美团/B站 +5%）；<b>韩国央行意外加息 25bp 致 KOSPI -7%、日经 -3%，资金回流港股</b>，南向连续 2 日爆买超百亿（7/14 约 110 亿、7/15 超 130 亿）。数据来源：<a href="https://m.cnfin.com/yw-lb//zixun/20260716/4441330_1.html" target="_blank">新华财经午评 7/16</a>、<a href="https://so.html5.qq.com/page/real/search_news?docid=70000021_0116a5862ef20352" target="_blank">中新经纬 7/16</a>、<a href="http://gu.qq.com/resources/shy/news/detail-v2/index.html#/?id=nesSN2026071607503897a7b34f&s=b" target="_blank">腾讯港股 7/16</a>、<a href="https://guba.eastmoney.com/news,cjpl,1744481719.html" target="_blank">东方财富/21世纪 7/16</a>。</p>

<h3>7/16 A 股午盘（结构分化 · 超3200只上涨）</h3>
<div class="perf">
  <div class="it"><div class="nm">上证指数（7/16 午盘）</div><div class="ch down">-0.82%</div></div>
  <div class="it"><div class="nm">深成指（7/16 午盘）</div><div class="ch down">-0.83%</div></div>
  <div class="it"><div class="nm">创业板指（7/16 午盘）</div><div class="ch down">-1.73%</div></div>
  <div class="it"><div class="nm">科创综指（7/16 午盘）</div><div class="ch down">-0.76%</div></div>
  <div class="it"><div class="nm">半日成交（7/16）</div><div class="ch">1.48万亿·缩量</div></div>
  <div class="it"><div class="nm">全市场上涨家数</div><div class="ch up">超3200只</div></div>
  <div class="it"><div class="nm">医疗服务/影视院线</div><div class="ch up">涨幅居前</div></div>
  <div class="it"><div class="nm">存储芯片/半导体</div><div class="ch down">延续调整</div></div>
  <div class="it"><div class="nm">医药活跃（哈药5连板）</div><div class="ch up">涨停潮</div></div>
  <div class="it"><div class="nm">券商板块（午盘）</div><div class="ch down">跌幅靠前</div></div>
</div>

<h3>7/16 港股盘中（三连阳 · 资金回流）</h3>
<div class="perf">
  <div class="it"><div class="nm">恒生指数（7/16 午盘）</div><div class="ch up">+1.93%</div></div>
  <div class="it"><div class="nm">恒生科技（7/16 午盘）</div><div class="ch up">+3.08%</div></div>
  <div class="it"><div class="nm">恒科（13:45 盘中）</div><div class="ch up">+3.37%</div></div>
  <div class="it"><div class="nm">阿里巴巴（盘中）</div><div class="ch up">+4~5%</div></div>
  ...
  <div class="it"><div class="nm">WTI 原油</div><div class="ch">79.60·三连涨</div></div>
  <div class="it"><div class="nm">布伦特</div><div class="ch">84.95·三连涨</div></div>
</div>
...
<p class="note">* 恒生科技 PE 分位 35.34%（平安口径）破 20% 线，按筛选规则退出深度低估、仅作定投；中证银行以 PB/股息率衡量为“绝对低估”豁免纳入。本表结论基于 7/15 收盘全天行情（剧烈分化：科创50 -4.25%、半导体跳水、医药/白酒/游戏逆势领涨——医疗 +4.08%、酒ETF +5.05%、游戏ETF +5.97%）+ 7/16 盘中行情（A 股午盘沪指 -0.82%/创指 -1.73%/超 3200 只上涨、医药影视领涨、券商走弱；港股三连阳恒科 +3.08%、韩国加息资金回流、南向连续 2 日爆买超百亿；美伊第二波打击确认、油价三连涨；7 款手机端侧 AI 备案、实验猴涨价印证 CRO 景气、中金三合一获受理 + 中金 H1 净利 +78~90%）+ 上半年 GDP +4.7%（Q2 +4.3%）+ 上半年社零同比 +1.3%（商品端偏弱）。医疗(512170) 维持“强烈偏多·领涨”最优先。</p>
...
<footer>
  ⚠️ 本报告由 AI 基于公开信息（天天基金、雪球/蛋卷基金、平安证券指数信号灯等平台）整理生成，仅供研究参考，<b>不构成任何投资建议或个股推荐</b>。基金有风险，投资需谨慎；估值分位会随行情变化，请以最新数据为准。本报告每日自动生成（本日为 {RUN_TS} <b>盘中快照 · 7/15 收盘估值 + 7/16 盘中行情 · 自动化执行</b>）。医疗(512170) 维持“强烈偏多·领涨”最优先；估值快照沿用平安证券指数信号灯口径（基准 7/15 收盘，与 7/14、7/15、7/16-08 版一致）；7/16 盘中新增：恒科 +3.08% 三连阳（韩国加息资金回流港股 + 南向连续 2 日爆买超百亿）、医疗服务/影视院线涨幅居前、券商板块午盘走弱、美伊冲突美军第二波打击确认 + 油价三连涨、7 款手机端侧 AI 备案、实验猴涨价印证 CRO 景气。
</footer>
...
def main():
    ...
    summary_line = (f"盘中快照 · 7/16 盘中（恒科+3.08%三连阳 + 韩国加息资金回流港股 + 南向连续2日超百亿 "
                    f"+ 医疗服务/影视强势 + 券商板块走弱 + 美伊冲突升级油价三连涨）→")
